using JoJoLibrary;
using Barrier = JoJoLibrary.Barrier;
using Library_Barrier = JoJoLibrary.Barrier;
using Library_Random = JoJoLibrary.Random;
using Random = JoJoLibrary.Random;

namespace JoJoLibrary.Abilities;
...
public class SandConstruct : StatChangeAbility
{
	public SandConstruct()
	{
		Name = "Sand Construct";
		MpCost = 45;
		StatChange = new Library_Barrier(barrierAmount: 0.35);
	}
}
...
public class Materialization : StatChangeAbility 
{
	public Materialization() 
	{
		...
		MpCost = 50;
		StatChange = new Library_Barrier(barrierAmount: 0.25);
	}
}
#endregion
...
public class DevilMisfortune : InflictStatusAbility 
{
	public DevilMisfortune() 
	{
		...
		MpCost = 45;
		Status = new Library_Random(duration: 4);
	}
}
#endregion
...
public class RainBarrier : StatChangeAbility 
{
	public RainBarrier() 
	{
		Name = "Rain Barrier";
		MpCost = 40;
		StatChange = new Library_Barrier(barrierAmount: 0.3);
	}
}
#endregion
...
public class Girlboss : InflictStatusAbility 
{
	public Girlboss() 
	{
		Name = "Girlboss";
		MpCost = 20;
		Status = new Library_Random(duration: 3);
	}
}
...
public class SleightOfHand : StatusAttackAbility 
{
	public SleightOfHand() 
	{
		...
		Status = new Library_Random(duration: 5, applyChance: 1);
		Cooldown = 4;
	}
}
