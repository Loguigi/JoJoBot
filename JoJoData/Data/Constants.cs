...
public static class BattleConstants 
{
	...
	public static readonly int BASE_EXP_GAIN = 10;
}

public static class StoredProcedures 
{
	public static readonly string GET_PLAYER_DATA = "Players_GetData";
	public static readonly string GET_PLAYER_INVENTORY = "Players_Inventory";
	...
	public static readonly string INVENTORY_SAVE = "Inventory_Save";
}